...
import captypess from "../webphotos/injection moulds/confetionry cap mould.webp";
import captypes from "../webphotos/injection moulds/cap types.jpg";

function CapMouldDetail() {
    const [mainImage, setMainImage] = useState(capMould);
              ...
              <div class="sticky top-0 overflow-hidden ">
                <div class="relative mb-6 lg:mb-10 lg:h-96 flex items-center">
                  <a class=" left-0 transform cursor-pointer lg:ml-2 top-1/2 translate-1/2">
                    <svg
                    onClick={()=>{slider>0 && setSlider(slider-33.3)}}
                  ...
                  <div className="w-[90%] overflow-hidden lg:h-full">
                    <div style={{transform: `translateX(-${slider}%)`}} className="w-[300%] lg:h-full flex duration-300">
                    <img
                    class="object-cover w-[33.33%] lg:h-full rounded-xl"
                    src={mainImage}
                    alt=""
                  />
                  <img
                        class="object-cover w-[33.3%] lg:h-full"
                        src={captypes}
                        alt=""
                      />
                      <img
                  ...
                  <a  class=" right-0 transform lg:mr-2 top-1/2 translate-1/2">
                    <svg
                    onClick={()=>{slider<=33.3 && setSlider(slider+33.3)}}
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      fill="currentColor"
                  ...
                  <div class="w-1/2 p-2 sm:w-1/4">
                    ...
                    class="block border border-gray-200 hover:border-blue-400 dark:border-gray-700 dark:hover:border-blue-300">
                      ...
                      style={{filter: slider == 33.3 && `grayscale(0%)`}}
                        class="object-cover animation-1 w-full lg:h-20"
                        src={captypes}
                        alt=""
                      />
                    </a>
              ...
              <div class="lg:pl-20">
                <div class="mb-6 ">
                  ...
                  <p class="navt inline-block  font-semibold text-gray-700 dark:text-gray-400 ">
                    <span>
                      With the intention of providing utmost satisfaction to the
                      clients, we are offering to them a high quality stock of
                      Plastic Moulding Dies. Our range of dies is designed by
                      using excellent quality plastic. Our offered range is
                      widely used in machines installed at industries like
                      textiles, electrial, electronics & mechanical engineering.
                      Customers can avail these Plastic Moulding Dies from us at
                      the best industrial prices. <br /> Plastic Cap Mould is a hard
                      metallic machine element that is commonly used in plastic
                      molding industries for the making of highly finished
                      plastic caps that are used as an enclosure to make
                      airtight seals over plastic bottles to prevent spilling of
                      stored products and avoid contact with environmental
                      impurities. Plastic Cap Mould offered by us is fabricated
                      by using alloyed steel that makes it capable to bear heavy
                      impacts and harsh working conditions.{" "}
                    </span>
                  </p>
                </div>
                <div class="mb-6">
