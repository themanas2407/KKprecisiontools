...
function ElectricFittingDetail() {
  const [mainImage, setMainImage] = useState(
    "https://5.imimg.com/data5/EX/WJ/MY-53043775/torch-body-plastic-mould-die.jpg"
  );
                  ...
                  <div className="w-[90%] overflow-hidden lg:h-full">
                    ...
                    >
                      ...
                      <img
                        ...
                        src="https://s.alicdn.com/@sc04/kf/HTB1T9oOXOjrK1RjSsplq6xHmVXaA.jpg_300x300.jpg"
                        alt=""
                      />
                      <img
                        class="object-contain w-[33.3%] lg:h-full"
                        src="https://5.imimg.com/data5/ANDROID/Default/2022/7/ES/FK/TP/24644874/product-jpeg-500x500.jpg"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div class="lg:pl-20">
                <div class="mb-6 ">
                  ...
                  <p class="navt inline-block  font-semibold text-gray-700 dark:text-gray-400 ">
                    <span>
                    We are successfully meeting the varied needs of our patrons by offering a wide gamut of Torch Body Plastic Moulding Die as per their precise needs.
                    </span>
                  </p>
                </div>
                <div class="mb-6">
