...
function ElectricFittingDetail() {
  const [mainImage, setMainImage] = useState(
    "https://cpimg.tistatic.com/08239027/b/4/Plastic-Spout-Mould.jpg"
  );
                ...
                <div class="relative mb-6 lg:mb-10 lg:h-96 flex items-center">
                  ...
                  <div className="w-[90%] overflow-hidden lg:h-full">
                    ...
                    >
                      ...
                      />
                      <img
                        class="object-conatin w-[33.3%] lg:h-full"
                        src="https://cpimg.tistatic.com/07861873/b/4/PVC-Wall-Plug-Mould.jpg"
                        alt=""
                      />
                      <img
              ...
              <div class="lg:pl-20">
                <div class="mb-6 ">
                  ...
                  <p class="navt inline-block  font-semibold text-gray-700 dark:text-gray-400 ">
                    <span>
                      We have carved a niche in the industry by manufacturing
                      and supplying Spout Cap Mould that is extensively used for
                      production of plastic caps of bottles and jars. Offered
                      mould is made available in variegated sizes to fulfill the
                      different requirements of our clients. The provided mould
                      is precisely manufactured with the aid of sophisticated
                      technology under the observation of our experts using
                      premium quality raw materials. Offered Spout Cap Mould can
                      be purchased from us at market-competent
                      prices.Features:Flawless finishSturdy constructionAccurate
                      dimensionsDurability
                    </span>
                  </p>
                </div>
                <div class="mb-6">
