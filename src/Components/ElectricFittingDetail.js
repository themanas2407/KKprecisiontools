...
function ElectricFittingDetail() {
  const [mainImage, setMainImage] = useState(
    "https://go4mould.com/wp-content/uploads/2021/12/pvc-pipe-fitting-mould-detail-1.jpg"
  );
                  ...
                  <div className="w-[90%] overflow-hidden lg:h-full">
                    ...
                    >
                      ...
                      <img
                        ...
                        src="https://5.imimg.com/data5/SELLER/Default/2023/9/342627402/UI/GU/SB/8530952/pvc-electrical-conduit-fitting-moulds-500x500.jpg"
                        alt=""
                      />
                      <img
                        class="object-cover w-[33.3%] lg:h-full"
                        src="https://5.imimg.com/data5/SELLER/Default/2023/9/342627293/PZ/UN/PV/8530952/pvc-electrical-conduit-fitting-moulds-1000x1000.jpg"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div class="lg:pl-20">
                <div class="mb-6 ">
                  ...
                  <h2 class="h max-w-xl mt-6 mb-6 text-xl font-semibold leading-loose tracking-wide text-gray-700 md:text-2xl dark:text-gray-300">
                    Electrical Fitting Mould
                    {/* {slider} */}
                  </h2>

                  <p class="navt inline-block  font-semibold text-gray-700 dark:text-gray-400 ">
                    <span>
                      We are supplying here the Electrical Mould for use in the
                      various commercial and industrial applications. Electrical
                      conduit main purpose is for use in electrical systems as a
                      housing for electrical wires or cables. PVC conduit is
                      often used in underground and wet location applications
                      where electrical cables need to be protected. An
                      electrical conduit is a tube used to protect and route
                      electrical wiring in a building or structure. The PVC
                      Electrical Conduit Mould is very accurate.
                    </span>
                  </p>
                </div>
                <div class="mb-6">
