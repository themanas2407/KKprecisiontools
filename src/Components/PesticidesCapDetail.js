...
function ElectricFittingDetail() {
  const [mainImage, setMainImage] = useState(
    "https://4.imimg.com/data4/RL/IW/MY-23090903/plastic-cap-molded-500x500.jpg"
  );
                  ...
                  <div className="w-[90%] overflow-hidden lg:h-full">
                    ...
                    >
                      ...
                      <img
                        ...
                        src="https://www.capmold-china.com/uploads/202236831/plastic-pesticide-cap-mould41289964959.jpg"
                        alt=""
                      />
                      <img
                        class="object-contain w-[33.3%] lg:h-full"
                        src="https://tiimg.tistatic.com/fp/1/004/785/caps-and-closures-moulds-497.jpg"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div class="lg:pl-20">
                <div class="mb-6 ">
                  ...
                  <h2 class="h max-w-xl mt-6 mb-6 text-xl font-semibold leading-loose tracking-wide text-gray-700 md:text-2xl dark:text-gray-300">
                    Pesticides Cap Mould
                    {/* {slider} */}
                  </h2>

                  <p class="navt inline-block  font-semibold text-gray-700 dark:text-gray-400 ">
                    <span>
                      The design and sealing of the plastic pesticide cap mould
                      must be guaranteed to prevent the leakage of toxic
                      liquids, and also ensure that there is no flash to ensure
                      the appearance of the plastic parts.
                    </span>
                  </p>
                </div>
                <div class="mb-6">
