...
function ElectricFittingDetail() {
  const [mainImage, setMainImage] = useState(
    "https://5.imimg.com/data5/SELLER/Default/2022/3/FB/LY/GI/57034/junction-box-mould-500x500.jpeg"
  );
                  ...
                  <div className="w-[90%] overflow-hidden lg:h-full">
                    ...
                    >
                      ...
                      <img
                        ...
                        src="https://s.alicdn.com/@sc04/kf/Haa5a5d60b7134aba9616c64eba593ac9X.jpg_720x720q50.jpg"
                        alt=""
                      />
                      <img
                        class="object-cover w-[33.3%] lg:h-full"
                        src="https://sc04.alicdn.com/kf/H156213d3e77442c2aa74c89eda1966afv.jpg"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div class="lg:pl-20">
                <div class="mb-6 ">
                  ...
                  <p class="navt inline-block  font-semibold text-gray-700 dark:text-gray-400 ">
                    <span>
                      We are specialist in designing & manufacturing Four
                      Impressions- Four way-25.0mm junction box mould. We use
                      global standard high quality steels for mould construction
                      and advanced manufacturing tehnology for high quality and
                      long life of the moulds with best competitive market
                      price.{" "}
                    </span>
                  </p>
                </div>
