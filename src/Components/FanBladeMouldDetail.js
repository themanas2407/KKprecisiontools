...
function ElectricFittingDetail() {
  const [mainImage, setMainImage] = useState(fan)
                  ...
                  <div className="w-[90%] overflow-hidden lg:h-full">
                    ...
                    >
                      ...
                      <img
                        ...
                        src="https://5.imimg.com/data5/OU/JY/UG/SELLER-5754767/fan-blade-plastic-injection-mould-500x500.jpg"                        alt=""
                      />
                      <img
                        class="object-cover w-[33.3%] lg:h-full"
                        src="https://m.media-amazon.com/images/I/51IeyIkodhL.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  <div class="w-1/2 p-2 sm:w-1/4">
                    ...
                    >
                      <img
                        ...
                        src="https://5.imimg.com/data5/OU/JY/UG/SELLER-5754767/fan-blade-plastic-injection-mould-500x500.jpg"
                        alt=""
                      />
                    </a>
                  </div>
              ...
              <div class="lg:pl-20">
                <div class="mb-6 ">
                  ...
                  <p class="navt inline-block  font-semibold text-gray-700 dark:text-gray-400 ">
                    <span>
                    It is our economic development purpose to keep our Manhole
                  Cover Compression Mould, Shower Thermosetting Mold, Plastic
                  Fan Injection Mould in sync with the times and our customers'
                  consumption enjoyment in sync with the times.                    </span>
                  </p>
                </div>
                <div class="mb-6">
