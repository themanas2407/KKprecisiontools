...
function ElectricFittingDetail() {
  const [mainImage, setMainImage] = useState(
    "https://5.imimg.com/data5/SELLER/Default/2021/3/DD/NG/EP/4604382/plastic-toy-mould-500x500.jpg"
  );
                  ...
                  <div className="w-[90%] overflow-hidden lg:h-full">
                    ...
                    >
                      ...
                      <img
                        ...
                        src="https://image.made-in-china.com/2f0j00UibkERFqazoW/Toy-Car-Playmobile-Toy-Vehicles-Swing-Car-Plastic-Children-Baby-Injection-Mould.webp"
                        alt=""
                      />
                      <img
                        class="object-contain w-[33.3%] lg:h-full"
                        src="https://5.imimg.com/data5/SELLER/Default/2021/3/RO/OQ/NC/71883236/-20210306084407-500x500.png"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div class="lg:pl-20">
                <div class="mb-6 ">
                  ...
                  <p class="navt inline-block  font-semibold text-gray-700 dark:text-gray-400 ">
                    <span>
                    In order to meet the various requirements of the customers, we are engaged in offering a wide assortment of Custom Plastic Toy Mould.                    </span>
                  </p>
                </div>
                <div class="mb-6">
